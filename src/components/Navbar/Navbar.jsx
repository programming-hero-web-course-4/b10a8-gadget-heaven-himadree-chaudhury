    ...
    >
      <div className="">
        <nav className="flex justify-between items-center ">
          ...
          {/* Icons */}
          <div className="hidden lg:flex items-center gap-4 text-lg active-btn">
            {/* Cart Icon */}
            <button className={`navigation-pane`} onClick={handleCartClick}>
              <svg
            ...
            {/* Wishlist Icon */}
            <button className="navigation-pane" onClick={handleWishlistClick}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
